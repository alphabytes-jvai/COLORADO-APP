...
const InteractiveMap: React.FC<InteractiveMapProps> = ({ onClose }) => {
  ...
  const [selectedLocation, setSelectedLocation] = useState(mockLocations[2]); 
...
//   {
//     id: "6",
//     name: "2464 Royal Ln. Mesa, New 45463",
...
//   const [searchQuery, setSearchQuery] = useState("");
//   const [filteredLocations, setFilteredLocations] = useState(mockLocations);
//   const [selectedLocation, setSelectedLocation] = useState(mockLocations[5]); // Default to the address shown in image
//   const [isSearching, setIsSearching] = useState(false);
...
//       {/* Map Background - Colorado-like terrain */}
//       <View className="absolute inset-0">
//         {/* Green areas representing forests/parks */}
//         <View className="absolute top-0 left-0 w-32 h-40 bg-green-200 rounded-br-3xl" />
//         <View className="absolute top-16 right-0 w-24 h-32 bg-green-300 rounded-bl-2xl" />
//         <View className="absolute bottom-0 left-8 w-28 h-36 bg-green-200 rounded-tr-3xl" />
        
//         {/* Roads - main highways */}
//         <View className="absolute top-1/3 left-0 right-0 h-1 bg-gray-400" />
//         <View className="absolute top-1/2 left-1/4 w-1 h-32 bg-gray-400" />
        
//         {/* Cities */}
//         <View className="absolute top-1/4 right-1/3 w-2 h-2 bg-gray-600 rounded-full" />
//         <View className="absolute top-1/2 left-1/3 w-2 h-2 bg-gray-600 rounded-full" />
        
//         {/* Route line from current location to destination */}
//         <View className="absolute top-1/3 left-1/4 w-48 h-32">
//           <View 
...
//       {/* Destination Marker */}
//       <View className="absolute" style={{ top: SCREEN_HEIGHT * 0.45, left: SCREEN_WIDTH * 0.65 }}>
//         <View className="bg-red-500 w-8 h-8 rounded-full items-center justify-center shadow-lg">
//           <MapPin size={16} color="white" />
//         </View>
//         <View className="w-0.5 h-4 bg-red-500 self-center" />
//       </View>

//       {/* Bottom Card with Location Info */}
//       <View className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl px-4 py-6 shadow-2xl">
//         {/* Location Info */}
...
//       {/* Map Controls */}
//       <View className="absolute right-4 top-32 space-y-3">
//         <TouchableOpacity className="bg-white p-3 rounded-xl shadow-lg">
//           <Locate size={20} color="#4DBA28" />
//         </TouchableOpacity>
//         <TouchableOpacity className="bg-white p-3 rounded-xl shadow-lg">
//           <RotateCcw size={20} color="#4DBA28" />
...
//               <TranslatedText>{item.coverage}</TranslatedText>
//             </Text>
...
//                 <TouchableOpacity
//                   onPress={() => handleDelete(item.id)}
//                   className="ml-3 bg-red-50 px-4 py-2 rounded-lg"
//                 >
//                   <Text className="text-red-600 text-sm font-medium">
//                     <TranslatedText>Delete</TranslatedText>
//                   </Text>
...
//               <TranslatedText>Downloading... 33% complete</TranslatedText>
//             </Text>
//           </View>
//         )}
//       </View>
...
//                 <TranslatedText>
//                   Offline maps allow you to navigate without internet connection. Download regions before traveling to remote areas for the best experience.
//                 </TranslatedText>
//               </Text>
//             </View>
//           }
...
//         key={option.id}
//         onPress={option.onPress}
//         className="bg-green-50 rounded-2xl p-5 mb-4 flex-row items-center justify-between"
//         activeOpacity={0.7}
//       >
//         <View className="flex-row items-center flex-1">
//           <View className="w-14 h-14 bg-white rounded-2xl items-center justify-center mr-4 shadow-sm">
//             <IconComponent size={26} color={option.color} />
//           </View>
//           <View className="flex-1">
...
//         {/* Info Text */}
//         <View className="mt-8 p-5 bg-blue-50 rounded-2xl">
//           <Text className="text-blue-800 text-sm text-center leading-5">
//             <TranslatedText>
//               Access detailed maps and navigation features to explore Colorado's best destinations with offline support.
//             </TranslatedText>
//           </Text>
//         </View>
//       </View>
